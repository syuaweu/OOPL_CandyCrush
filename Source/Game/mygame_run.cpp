...
void CGameStateRun::show_text_by_phase() {
	...
	CTextDraw::ChangeFontLog(pDC, 21, "微�??�?�?�?", RGB(0, 0, 0), 800);

	if (phase == 1 && sub_phase == 1) {
		CTextDraw::Print(pDC, 237, 128, "修�?��?????主�??�?");
		CTextDraw::Print(pDC, 55, 163, "�???��?��?��?��????? resources ??��?? giraffe.bmp ???�?�?");
		CTextDraw::Print(pDC, 373, 537, to_string(clock()));
	}
	else if (phase == 2 && sub_phase == 1) {
		CTextDraw::Print(pDC, 26, 128, "�?�???????段�??�???��?�鹿??��????????�?�?左�?�移?????��?????�?置�??");
		CTextDraw::Print(pDC, 373, 537, "???�? Enter ??��??�?�?");
	}
	else if (phase == 3 && sub_phase == 1) {
		CTextDraw::Print(pDC, 205, 128, "幫�??�????�?�????寶箱");
		CTextDraw::Print(pDC, 68, 162, "設�??�?�?�???��?�鹿??��?�寶箱�??�?�?寶箱�?失�??");
		CTextDraw::Print(pDC, 68, 196, "�?�?寶箱�???��??�?使�?? RGB(255, 255, 255)");
		CTextDraw::Print(pDC, 373, 537, "???�? Enter ??��??�?�?");
	}
	else if (phase == 4 && sub_phase == 1) {
		CTextDraw::Print(pDC, 173, 128, "幫�??�????�?�??????????好�?????");
		CTextDraw::Print(pDC, 89, 162, "已�??幫�?????�???��??????????��??�?�???�以�?�?移�??");
		CTextDraw::Print(pDC, 110, 196, "寫�??�?�?�?�?�??????????好�????????????????��??");
		CTextDraw::Print(pDC, 373, 537, "???�? Enter ??��??�?�?");
	}
	else if (phase == 5 && sub_phase == 1) {
		CTextDraw::Print(pDC, 173, 128, "幫�??�????�?�???????");
		CTextDraw::Print(pDC, 89, 162, "設�??�?�?�???��?�鹿??��?��??�?�?�?????????????");
		CTextDraw::Print(pDC, 373, 537, "???�? Enter ??��??�?�?");
	}
	else if (phase == 6 && sub_phase == 1) {
		CTextDraw::Print(pDC, 173, 128, "幫�??�????�?�?�?????????��?????");
		CTextDraw::Print(pDC, 89, 162, "設�??�?�?�?????????��????��??顯示 OK �????止�?????");
		CTextDraw::Print(pDC, 373, 537, "???�? Enter ??��??�?�?");
	}
	else if (sub_phase == 2) {
		CTextDraw::Print(pDC, 268, 128, "�????�?");
	}
